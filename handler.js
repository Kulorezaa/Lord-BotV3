...
"headerType": "DOCUMENT", "documentMessage": {
      ...
      case 'demote':
        ...
        if (chat.detect) this.send2ButtonLoc(jid, banp, text, 'BukanWahyu', 'MENU', '#menu', 'OWNER', '#owner', null, {
          contextInfo: {
...
`.trim(), 'BukanWahyu', 'DISABLE DELETE', '.disable delete', {
      quoted: m.message,
      contextInfo: {
...
let fot = `Made by @${'62895412779117'.split('@')[0]}`
  let msg = {
    rowner: '*CREATOR ONLY*',
    owner: '*OWNER ONLY*',
    mods: '*MODERATOR ONLY*',
...
▸ Contoh : #daftar ${user}.13`*/
  ...
  if (msg) return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          ...
          "buttonText": "BukanWahyu",
          "listType": "SINGLE_SELECT",
          "sections": [
                            {
                                "rows": [{
                                         "title": `MY OWNER`,
                                         "description": "List Owner BukanWahyu",
                                         "rowId": ".nowner"
                                    }, {
                                         "title": `ABOUT`,
                                         "description": " Tentang BukanWahyu", 
                                         "rowId": ".info"
                                    }, {
                                         "title": `LIST MENU`,
                                         "description": " List Menu BukanWahyu",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `SCRIPT`,
                                         "description": " Source code BukanWahyu",
                                         "rowId": ".sc"
                                         }, {
                                         "title": `GROUP BOT`,
                                         "description": " List Group Official BukanWahyu",
                                         "rowId": ".gcbot"
                       }],
